# Organizes data from ESPNData.json into a readable format
import json
from constants import STATS_MAP
infile = open('Setup/ESPNData.json')
pitcherOutfile = open('Algorithm/pitchers2.txt', 'w')
batterOutfile = open('Algorithm/batters2.txt', 'w')
